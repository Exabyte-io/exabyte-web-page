...
const Capabilities: FC = () => {
  ...
  return (
    <Layout className={'section capabilities-wrapper'}>
      ...
      >
        <Col style={{ padding: '0' }}>
          <Typography.Paragraph className={'capabilities-wrapper-title'}>Platform Capabilities</Typography.Paragraph>
          <Typography.Paragraph className={'capabilities-wrapper-description'}>From idea to result - let's get there
            faster together!</Typography.Paragraph>
        </Col>
        <Col style={{ padding: '0' }} xl={24}>
          <Collapse accordion bordered={false} expandIconPosition={'right'}
            ...
            <Panel header='Encrypted data at rest and in-transfer, network partitioning, and more for maximum security'
                   key='9'>
